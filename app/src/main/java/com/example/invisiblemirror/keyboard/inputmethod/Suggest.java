...
import com.example.invisiblemirror.keyboard.latin.Dictionary;
...
/**
    ...
    public List<CharSequence> getSuggestions(View view, WordComposer wordComposer,
        ...
        if (mOriginalWord != null) {
        	...
        	//mOriginalWord = HangulAutomata.encode(mOriginalWord.toString());
        ...
        if (mOriginalWord != null) {
        	...
        	String str = HangulAutomata.encode(mOriginalWord.toString());
