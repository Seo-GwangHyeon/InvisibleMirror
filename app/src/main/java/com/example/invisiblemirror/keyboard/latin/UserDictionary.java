...
import com.example.invisiblemirror.keyboard.inputmethod.HangulAutomata;
import com.example.invisiblemirror.keyboard.inputmethod.SoftKeyboard;
    ...
    private void addWords(Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            while (!cursor.isAfterLast()) {
                ...
                word = HangulAutomata.decode(word);
                if(SoftKeyboard.DEBUG)
                	Log.v(SoftKeyboard.PRJ_NAME, "dictionary add: \"" + word + "\"");
